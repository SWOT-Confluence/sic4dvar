...
class SOS:
    def __init__(self, path, reach_ids_list = [], constraint = "constrained", version = "16"):
        ...
        #print("Init:", self.reach_ids_per_continent, len(self.reach_ids_per_continent['NA']))

        #self.get_stations_reach_ids() #get reach_ids of all the stations of all the continents
    ...
    def init_reach_ids_all(self, reach_ids_list = []):
        ...
        #print(self.reach_ids_per_continent)
    ...
    def get_stations_reach_ids(self):
        ...
        #station_reach_id = sos_dataset[station]["%s_reach_id" %station]
        ...
        #print(dataset[station]["%s_reach_id" %station])
        print(bug)

    #station_reach_id = sos_dataset[station]


def get_station_q_and_qt(sos_dataset, reach_id):
    out_sos_q, out_sos_date = [], []
    continent_code = int(reach_id//1e10)
